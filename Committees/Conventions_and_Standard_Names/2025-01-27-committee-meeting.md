...
* At a recent Governance Panel meeting, it was suggested that we could announce the start of three-week conventions "cooling off" periods, as announcements in the discuss repo, for those who don't subscribe to the conventions repo.
...
* People often use layers of standards, e.g. netCDF - CF - cdatanet/CMIP. CF provides the solid foundations on which others can build.
