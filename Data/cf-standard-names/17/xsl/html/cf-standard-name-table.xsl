...
<b>Version <xsl:value-of select="version_number"/>, <xsl:value-of select="date"/></b>
            <br/>
            <br/>
Refer to <a href="http://cf-pcmdi.llnl.gov/documents/cf-standard-names/guidelines">Guidelines for Construction of CF Standard Names</a> for information on how the names are constructed and interpreted, and how new names could be derived.
            <br/>
            <br/>
