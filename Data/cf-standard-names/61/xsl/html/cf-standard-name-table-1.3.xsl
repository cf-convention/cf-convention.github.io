...
The canonical units associated with each standard name are usually the SI units for the quantity. <span class="link-external"><a href="http://cf-convention.github.io/Data/cf-conventions/cf-conventions-1.6/build/cf-conventions.html#standard-name">Section 3.3 of the CF conventions</a></span> states: "Unless it is dimensionless, a variable with a standard_name attribute must have units which are physically equivalent (not necessarily identical) to the canonical units, possibly modified by an operation specified by either the standard name modifier ... or by the cell_methods attribute." Furthermore, <span class="link-external"><a href="http://cf-convention.github.io/Data/cf-conventions/cf-conventions-1.6/build/cf-conventions.html#idp4625472"> Section 1.3 of the CF conventions</a></span> states: "The values of the units attributes are character strings that are recognized by UNIDATA's Udunits package [UDUNITS], (with exceptions allowed as discussed in Section 3.1, “Units”)." For example, a variable with the standard name of "air_temperature" may have a units attribute of "degree_Celsius" because Celsius can be converted to Kelvin by Udunits. For the full range of supported units, refer to the <a href="http://www.unidata.ucar.edu/software/udunits/udunits-2.2.17/doc/udunits/udunits2.html#Database"> Udunits documentation</a>. Refer to the <a href="http://cf-convention.github.io/Data/cf-conventions/cf-conventions-1.6/build/cf-conventions.html"> CF conventions</a> for full details of the units attribute.<br/><br/>
